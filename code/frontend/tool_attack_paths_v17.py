...
_SPLASH_LOGO_PATH = (_SCRIPT_DIR / "../../logo/1770647509745-Photoroom.png").resolve()


try:
    from tool_threat_mapper_v6 import (
...
# the AssetMapDialog without requiring access to tool_threat_mapper_v6 source.
# ─────────────────────────────────────────────────────────────────────────────
    ...
    def __init__(self, backend_script=None):
        ...
        if not _SHARED_OK:
            ...
            messagebox.showerror(
                "Import error",
                f"Please place tool_threat_mapper_v6.py in the same folder.\n{_IMPORT_ERR}"
            )
            self.destroy()
            return
  ...
  "functional_level_analysis": {{
    ...
    "functional_scenarios": [
      {{
        ...
        "cve_refs": [
          {{
            ...
            "source": "hierarchy_data_ver0.1.json"
          }}
        ],
        "attack_tree": {{
      ...
      {{
        ...
        "cve_refs": [{{"cve_id": "CVE-YYYY-NNNNN", "affected_component": "...", "vulnerability_description": "...", "exploitation_in_attack": "...", "cvss_severity": "High", "cvss_score": "unknown", "source": "hierarchy_data_ver0.1.json"}}],
...
'''
# Entry point
=> python tool_attack_paths_v17.py --backend ../backend/parse_attack_graph_v37.py
'''
