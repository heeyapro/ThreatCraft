...
python parse_attack_graph_v09.py --tm7 "Automotive DFD_B.tm7" --type "Remote/Adjacent" --target "Door" --boundary "External Vehicle Boundary" --asset-map "asset_to_threats.json" --threat-map "threat_to_tactic.json" --out "attack_graph.json"
python parse_attack_graph_v09.py --tm7 "Automotive DFD_B.tm7" --type "Local/Physical" --target "Door" --boundary "External Vehicle Boundary" --asset-map "asset_to_threats.json" --threat-map "threat_to_tactic.json" --out "attack_graph.json"
