...
def main():
    ...
    if args.render_attack_tree:
        try:
            png_path = Path(args.attack_tree_png)
...
Exec examples:
# remote + attack tree
python parse_attack_graph_v17.py --tm7 "../in/Automotive DFD_B.tm7" --type remote --target "Door" --boundary "External Vehicle Boundary"  --asset-map "threat_library/asset_to_threats_ver0.1.json" --threat-map "threat_library/threat_to_tactic.json"  --attack-vector-map "threat_library/attack_vector_feasibility.json" --dependency-map "threat_library/dependency.json"  --out "../out/attack_graph_remote_filtered.json" --render-attack-tree --attack-tree-png "../out/attack_tree_remote_filtered.png" --merged-graph-out "../out/merged_attack_graph_remote_filtered"

# adjacent + attack tree
python parse_attack_graph_v17.py --tm7 "../in/Automotive DFD_B.tm7" --type adjacent --target "Door" --boundary "External Vehicle Boundary"  --asset-map "threat_library/asset_to_threats_ver0.1.json" --threat-map "threat_library/threat_to_tactic.json"  --attack-vector-map "threat_library/attack_vector_feasibility.json" --dependency-map "threat_library/dependency.json"  --out "../out/attack_graph_adjacent_filtered.json" --render-attack-tree --attack-tree-png "../out/attack_tree_adjacent_filtered.png" --merged-graph-out "../out/merged_attack_graph_adjacent_filtered"

# local + attack tree
python parse_attack_graph_v17.py --tm7 "../in/Automotive DFD_B.tm7" --type local --target "Door" --boundary "External Vehicle Boundary"  --asset-map "threat_library/asset_to_threats_ver0.1.json" --threat-map "threat_library/threat_to_tactic.json"  --attack-vector-map "threat_library/attack_vector_feasibility.json" --dependency-map "threat_library/dependency.json"  --out "../out/attack_graph_local_filtered.json" --render-attack-tree --attack-tree-png "../out/attack_tree_local_filtered.png" --merged-graph-out "../out/merged_attack_graph_local_filtered"

# physical + attack tree
python parse_attack_graph_v17.py --tm7 "../in/Automotive DFD_B.tm7" --type physical --target "Door" --boundary "External Vehicle Boundary"  --asset-map "threat_library/asset_to_threats_ver0.1.json" --threat-map "threat_library/threat_to_tactic.json"  --attack-vector-map "threat_library/attack_vector_feasibility.json" --dependency-map "threat_library/dependency.json"  --out "../out/attack_graph_physical_filtered.json" --render-attack-tree --attack-tree-png "../out/attack_tree_physical_filtered.png" --merged-graph-out "../out/merged_attack_graph_physical_filtered"
